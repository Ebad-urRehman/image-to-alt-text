...
button_clicked = st.download_button("Download as CSV", data=output_csv, file_name=date, mime='text/csv', on_click=output_csv = st.session_state.mydataframe.to_csv(index=False).encode('utf-8'))
